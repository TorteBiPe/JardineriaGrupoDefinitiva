...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=192.168.91.202; Database=jardineria; User=SA; Password=01022000Raul");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                entity.HasKey(e => e.CodigoCliente)
                    .HasName("PK__cliente__4D182E8D9E0B0C36");
            ...
            modelBuilder.Entity<DetallePedido>(entity =>
            {
                entity.HasKey(e => new { e.CodigoPedido, e.CodigoProducto })
                    .HasName("PK__detalle___3AD5D561BF04E0A9");
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                entity.HasKey(e => e.CodigoEmpleado)
                    .HasName("PK__empleado__CDEF1DDE19D22153");
            ...
            modelBuilder.Entity<GamaProducto>(entity =>
            {
                entity.HasKey(e => e.Gama)
                    .HasName("PK__gama_pro__4877EEE445FCF7A2");
            ...
            modelBuilder.Entity<Oficina>(entity =>
            {
                entity.HasKey(e => e.CodigoOficina)
                    .HasName("PK__oficina__754CF298004235AD");
            ...
            modelBuilder.Entity<Pago>(entity =>
            {
                entity.HasKey(e => new { e.CodigoCliente, e.IdTransaccion })
                    .HasName("PK__pago__CCF5828494622B3E");
            ...
            modelBuilder.Entity<Pedido>(entity =>
            {
                entity.HasKey(e => e.CodigoPedido)
                    .HasName("PK__pedido__BBD0C51B55BB04FE");
            ...
            modelBuilder.Entity<Producto>(entity =>
            {
                entity.HasKey(e => e.CodigoProducto)
                    .HasName("PK__producto__105107A9D81BDA32");
